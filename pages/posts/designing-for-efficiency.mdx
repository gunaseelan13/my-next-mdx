...
Current affairs of Product Design When faced with real world hard problems(complicated business decisions), we subconsciously substitute it with an easier problem(font, colours, shadow,style) and solve that instead.
